...
gemini.configure(api_key="AIzaSyAvY9qu7lsBDW7BEeKN8COKS5Tdl8HoJN4")
...
def make_poema():
    try:
        ...
        prompt = f"""
        Crie um poema de no mínimo 600 palavras ou em torno de 30 linhas organizado em uma estrutura de parágrafos devidamente separados com versos e estrofes. 
        Use as palavras {palavras} como partes principais do poema.
